...
/**
 * DES加密介绍 DES是一种对称加密算法，<br>
 * 所谓对称加密算法即：加密和解密使用相同密钥的算法。<br>
...
public class DES {
	...
	public static void main(String args[]) {
		...
		String hexStr = Tools.bytesToHexString(result);
		...
		try {
			...
			decryResult = DES.decrypt(Tools.hexStringToBytes(hexStr), password);
			System.out.println("解密后：" + new String(decryResult));
		} catch (Exception e1) {
			e1.printStackTrace();
		}
